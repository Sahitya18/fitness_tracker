...
* The original package name 'com.fitness.add-meal-service' is invalid and this project uses 'com.fitness.add_meal_service' instead.
...
```
$ docker run --rm -p 8080:8080 add-meal-service:0.0.1-SNAPSHOT
```
